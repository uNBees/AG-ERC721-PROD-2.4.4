      ...
      <>
        {this.canMint() ?
          ...
          <div className="cannot-mint">
            ...
            {this.props.isWhitelistMintEnabled ? <>You are not included in the <strong>allow list</strong>.</> : <>The contract is <strong>paused</strong>.</>}<br />
            Please come back during the Open Minting!
          </div>
        }
      </>
    );
